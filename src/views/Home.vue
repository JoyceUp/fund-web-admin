    ...
    <el-row class="container">
        ...
        <el-col :span="24" class="main">
            <aside :class="collapsed?'menu-collapsed':'menu-expanded'">
                <!--导航菜单-->
                <el-menu  theme="dark" :default-active="$route.meta" class="el-menu-vertical-demo" @open="handleopen"
    ...
    export default {
        ...
        methods: {
            ...
            initUserMenu() {
                ...
                //console.log("loc:",loc_router_map);
                let remote_router_map = new Object();
                //  //console.log(urlList)
                for (let index in urlList) {
                    let router = urlList[index];

                    let chid_router_map = new Object();
                    for (let l in router.children) {

                        chid_router_map[router.children[l].code] = router.children[l];
                        loc_urlList.push(router.children[l]);
                    }
                    router.childrenCode = chid_router_map;

                    remote_router_map[router.code] = router;
                }
                //console.log("remote:",remote_router_map);
