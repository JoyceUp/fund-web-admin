<template>
    <div class="login_bg" :style="{background:bgImage}">
    <el-form :model="ruleForm2" :rules="rules2" ref="ruleForm2" label-position="left" label-width="0px"
             class="demo-ruleForm login-container">
        <h3 class="title">TF基金管理系统 <i>v1.0.0</i></h3>
    ...
    export default {
        ...
        methods: {
            initBg(){
                ...
                let bgNum= Math.floor(Math.random()*this.bgImageArray.length)
                console.log(bgNum)

                this.bgImage="url(/assets/images/"+this.bgImageArray[bgNum]+") center"
