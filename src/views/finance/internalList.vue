<template xmlns:el-col="http://www.w3.org/1999/html">
    <section>
        ...
        <el-table stripe v-loading="listLoading" :data="items" style="width: 100%">
            ...
            <el-table-column prop="sale_full_name" label="内勤姓名"></el-table-column>
            <el-table-column prop="employee_no" label="内勤编号"></el-table-column>
            ...
            <el-table-column prop="company_name" label="内勤公司"></el-table-column>
        </el-table>
        ...
        methods: {
          ...
          //      let condition = Object.assign(this.filters);
            ...
            exportExcel() {
                this.$refs['filters'].validate((valid) => {
                    if (valid) {
                        ...
                        API.getInternalExport(params).then((res) => {
            ...
            getItems(num) {
                ...
                API.getInternalList(paras).then((res) => {
