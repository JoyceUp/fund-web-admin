...
exports.internal = {
    list : function (req, res, next) {
        ...
        request.get(`${API.internal.internal_list}`)
    ...
    //         token: req.cookies.token
    //     };
    //     request.get(`${API.internal.internal_list}/exist`)
    //         .query({msg: JSON.stringify(req.body)})
    //         .set(header)
    //         .end(function (_req, _res) {
    //             res.json(JSON.parse(_res.text))
    ...
    export:function (req, res, next) {
        ...
        let api = `${API.internal.internal_list}/export`
        let params = req.body
        exportExcel(req, res, header, params, api, "内勤业绩");
    }
};
